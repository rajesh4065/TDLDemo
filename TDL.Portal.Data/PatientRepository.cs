    ...
    public class PatientRepository : IPatientRepository
    {
        ...
        public async Task<PatientDetailsDto> GetPatientDetails()
        {
            try
            {
                ...
                var response = await this._httpClient.GetAsync("https://localhost:44317/api/Patient/GetPatientDetails");
        ...
        public async Task<PatientOutPutDto> UpdatePatientDetails(PatientInputDto patientInputDto)
        {
            try
            {
                ...
                var response = await this._httpClient.PutAsync("https://localhost:44317/api/Patient/UpdatePatientDetails", content);
